...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = //"pk.eyJ1IjoiZGFlc2VsaXhpciIsImEiOiJja2d0cW9yM28wMGY1MnRwbG13dXY5eXZuIn0.utV2YyKPZB_wYkVeVwzbxQ";
...
if (loginForm) loginForm.addEventListener("submit", function (e) {
  ...
  var password = document.querySelector("#password").value; //console.log(email, password);
